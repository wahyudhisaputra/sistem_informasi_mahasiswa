	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE tbl_mahasiswa SET username='$username', level='$level', nama='$nama', kelas='$kelas', no_telepon='$no_telepon', email='$email', dosen_pembimbing='$dosen_pembimbing', jurusan='$jurusan' WHERE nim='$nim'") or die(mysqli_error()); 
				if($update){
