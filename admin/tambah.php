		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
					if($pass1 == $pass2){
						$pass = md5($pass1);
						$insert = mysqli_query($koneksi, "INSERT INTO tbl_mahasiswa(nim, nama, kelas, no_telepon, email, dosen_pembimbing, jurusan, username, level, password) VALUES('$nim','$nama', '$kelas', '$no_telepon', '$email', '$dosen_pembimbing', '$jurusan', '$username', '$level', '$pass')"
					)
					 or die(mysqli_error());
						if($insert)
						{
